...
def ruppersberger_extract_issues(issues_html, base_link):
...
def ruppersberger_extract_article_links(issue, base_link):
    print(issue)
...
def ruppersberger_extract_article(article_link):
    try:
